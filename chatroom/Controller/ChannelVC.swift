...
class ChannelVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        SocketService.instance.getChannel { (succsess) in
            if succsess{
    ...
    func setupUserInfo(){
        if AuthService.instance.isLoggedIn{
            ...
            userImage.backgroundColor = UserDataService.instance.returnUIClor(components: UserDataService.instance.avatarColor)
        }else{
